      ...
      <header className="header d-flex justify-center ">
        <div className="container d-flex justify-between">
          ...
          <nav className="d-flex align-center">
            <a href="#" className="shop-cart d-flex align-center">
              <img
                className="h-icon mr-10"
                src="img/icons/cart.svg"
                alt="cart icon"
              />
              <h4>1204 руб.</h4>
            </a>
            <a href="#" className="favorites d-flex ml-30 mr-30">
              <img className="h-icon" src="img/icons/like.svg" alt="like" />
            </a>
            <a className="user d-flex" href="#">
              <img className="h-icon" src="img/icons/user.svg" alt="" />
            </a>
          </nav>
        </div>
      </header>
        ...
        <div className="container">
          ...
          <div className="products">
            <div className="product ">
              <button className="product_like d-flex align-center justify-center">
                <svg
                  width="22"
                  height="19"
                  viewBox="0 0 22 19"
              ...
              <div className="product_img mb-15">
                <img src="img/products/sneakers.jpg" alt="sneakers" />
              </div>
              <p className="product_dscprt mb-15">
                Мужские Кроссовки Nike Blazer Mid Suede
              </p>
              <div className="product_foot d-flex justify-between align-center">
                <div className="price">
                  <span>Цена</span>
                  <h5>12 999 руб</h5>
                </div>
                <button className="product_add-btn d-flex align-center justify-center">
